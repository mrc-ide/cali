...
First, let's run a sense check that our summary function works!
```{r}
run_simulation(
...
Looks good! The summary produces a prevalence summary in the same format as our
target. Now time for the calibration. Here we set the tolerance to 0.005. This means that
